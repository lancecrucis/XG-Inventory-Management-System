...
import xgLogo from './assets/xgLogo.png'
...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      {/* Left Panel */}
      <div className="relative hidden lg:flex flex-col justify-between bg-zinc-900 p-12 text-zinc-100">

        <div className="relative z-20">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <div className="size-8 rounded-lg bg-primary-foreground/10 backdrop-blur-sm flex items-center justify-center">
              <img src={xgLogo} alt="XG Logo" className="size-10 object-contain" />
            </div>
            <span>Your <b>X</b>tra ordinary <b>G</b>lobal Partner</span>
          </div>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10 ">
            <img src={companyLogo} alt="XG Logo" className="size-40 object-contain m-auto" />
            <h1 className="text-3xl font-bold tracking-tight mb-2">XG Inventory System</h1>
            <p className="text-muted-foreground text-sm">Admin access only — enter your credentials</p>
          </div>
